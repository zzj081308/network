...
在FW1上配置NAPT，nat的ip为192.168.40.100

配置地址池napt_pool 1

里面只放一个地址192.168.40.100

```
FW1
[FW1]nat address-group napt_pool 1
[FW1-address-group-napt_pool]section 1 192.168.40.100 192.168.40.100
[FW1-address-group-napt_pool]quit
```
...
```
[FW1]nat-policy
[FW1-policy-nat]rule name napt_out
[FW1-policy-nat-rule-napt_out]source-zone trust
[FW1-policy-nat-rule-napt_out]destination-zone untrust
[FW1-policy-nat-rule-napt_out]source-address 192.168.1.0 24
[FW1-policy-nat-rule-napt_out]source-address 192.168.2.0 24
[FW1-policy-nat-rule-napt_out]action source-nat address-group napt_pool
```

在PC5处抓包可见发过来的ICMP包源ip已经是192.168.40.100了

![](pic/Snipaste_2026-08-12_00-27-45.png)
